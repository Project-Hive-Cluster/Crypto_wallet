...
export default function Admin() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#000e" }}
    >
      <div className="row align-items-center g-lg-5 py-5">
        <div className="col-lg-7 text-center text-lg-start">
          <h1
            className="display-4 fw-bold lh-1 mb-3 m-3"
            style={{ color: "#09b372" }}
          >
            Admin
          </h1>
        ...
        <div className="col-md-12 mx-auto col-lg-8">
          <form
            className="p-5 p-md-5 border rounded-3 bg-light"
          ...
          >
            ...
            <div className="text-bg-danger rounded  p-5">
              <small className="">
                By enabling Master key you might damage the block.
              </small>
            </div>
