  ...
  const handelTransfer = () => {
    {
      ...
      const options = {
        ...
        data: {
          waletid: sender,
          data: massage ? massage : `${sender} > ${reciver} `,
          to: reciver,
          amount: amount,
        },
      };
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            {output ?
              ...
              : <div className="modal-body p-5 "><div>{JSON.stringify(output)}</div></div>
            }
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" onClick={handelTransfer}>Send</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="p-4 p-md-5 border rounded-3 bg-light">
            ...
            <div className="input-group mb-3">
              ...
              <div className="form-floating mb-3">
                <input type="number" className="form-control" onChange={(e) => setSenders(e.target.value)}
                />
            ...
            <div className="form-floating mb-3">
              <input type="number" className="form-control" onChange={(e) => setReciver(e.target.value)}
              />
            ...
            <button onClick={handelValidition} type="button" className="w-100 btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
              Send
            </button>
